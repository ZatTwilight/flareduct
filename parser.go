...
// globalOptions holds flags that may appear before the subcommand.
...
// parseLeadingGlobals extracts global flags that may appear before the
// subcommand. It stops at the first positional argument or unknown flag.
...
// upOptions is the fully resolved set of options for the up/run command.
...
func (o upOptions) resolveOptions() ResolveOptions {
...
// parseUpArgs parses flags and the single positional target for the up/run
// command. It accepts both global and command-local flags so users can place
// them anywhere in the command line.
